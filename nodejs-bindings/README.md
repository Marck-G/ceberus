...
Building nodejs-bindings requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
## Exploring nodejs-bindings

After building nodejs-bindings, you can explore its exports at the Node console:
